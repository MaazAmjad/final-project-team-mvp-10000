...
def train_model(output_grid_dir_name, bert_model, max_seq_len, learning_rate, num_train_epochs):
    ...
    shared_arguments = '--data_dir=../semeval/ --bert_model=bert-large-uncased --task_name=semeval --do_train  --do_lower_case --train_batch_size=32 --gradient_accumulation_steps=8 --eval_batch_size=4 --model_path=unsupervised_large_model/model.pth'
